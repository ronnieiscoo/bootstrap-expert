...
- `component:agent`, `component:command`, `component:docs`, `component:skill`
...
- `maintenance` - Maintenance tasks and reports
- `pinned` - Never mark as stale
- `reverted` - Merged but later reverted from codebase
- `roadmap` - Long-term roadmap item (never mark as stale)
